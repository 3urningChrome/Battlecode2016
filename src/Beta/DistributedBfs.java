...
public class DistributedBfs extends AusefulClass {
	...
	private static boolean it_is_navigatable(MapLocation is_this_location_navigatable) throws GameActionException{
		boolean too_much_rubble = rc.senseRubble(is_this_location_navigatable) >= GameConstants.RUBBLE_SLOW_THRESH;
		
		if(too_much_rubble || !rc.onTheMap(is_this_location_navigatable))
			return false;
