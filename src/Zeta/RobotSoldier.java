...
public class RobotSoldier extends AusefulClass {
	...
	private static void standard_turn() throws GameActionException {
		...
		if (closest_Comms_data != null){
			...
			if(rc.canSense(destination) && current_location.distanceSquaredTo(destination) < 9){ //can't see enemies, but can sense where they should be. so remove them
