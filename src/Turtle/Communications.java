...
public class Communications extends AusefulClass{
	...
	public static void broadcast_enemy_locations() throws GameActionException {
		if(Scanner.can_see_hostiles()){
			for(RobotInfo hostile:Scanner.nearby_hostiles){
				broadcast_message(Location_Data, convert_MapLocation_to_integer(hostile.location),my_type.sensorRadiusSquared);
			}
		}
	}
